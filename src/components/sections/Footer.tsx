...
export default function Footer() {
  ...
  return (
    <footer className="relative py-16 bg-secondary">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-text-secondary">{personalInfo.location}</li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-text-secondary text-sm">
            © {currentYear} Jashan Shetty. All rights reserved.
          </p>
          <p className="text-text-secondary text-sm">
      ...
      {/* Back to top button */}
      <motion.button
        className="fixed bottom-8 right-8 w-12 h-12 rounded-full bg-accent text-white flex items-center justify-center shadow-lg z-50"
